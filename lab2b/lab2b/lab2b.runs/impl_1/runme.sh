...
HD_PWD='C:/Users/quyvan/Desktop/lab2b/lab2b/lab2b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sbl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sbl_wrapper.tcl -notrace

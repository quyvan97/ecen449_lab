...
HD_PWD='C:/Users/quyvan/Desktop/lab2b/lab2b/lab2b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sbl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sbl_wrapper.tcl

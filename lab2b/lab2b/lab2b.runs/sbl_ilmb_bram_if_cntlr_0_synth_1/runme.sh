...
HD_PWD='C:/Users/quyvan/Desktop/lab2b/lab2b/lab2b.runs/sbl_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sbl_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sbl_ilmb_bram_if_cntlr_0.tcl
